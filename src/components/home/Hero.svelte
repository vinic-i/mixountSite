	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 d-flex flex-column justify-content-center">
				<h1 data-aos="fade-up">Nós oferecemos soluções modernas para o crescimento do seu negócio.</h1>
				<h2 data-aos="fade-up" data-aos-delay="400">Somos o time Mixou NT</h2>
